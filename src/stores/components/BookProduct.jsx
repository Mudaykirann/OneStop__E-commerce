...
function BookProduct() {
    ...
    const { id } = useParams();
    const product = booksData.find((product) => product.id === id);
                ...
                <div className="container px-[5%] h-[100vh] relative ">
                    ...
                    <div className="mini-container flex gap-x-12">
                        ...
                        <div className="right pt-4 w-[50%]">
                            ...
                            <h2 className="title text-5xl py-2">{product.title}</h2>
                            <p className="py-[4px] text-[18px]">{product.author}</p>
                            <div className="title text-[15px] flex items-center gap-x-2 py-2"><IoMdStar size={22} /><p className="text-gray-700">9.5/10 . 15 reviews</p></div>
                            <p className="py-[5px] flex items-center gap-x-2"><TrendingUp size={18} /> <span className="text-xl">{product.category}</span></p>
